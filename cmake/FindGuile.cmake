...
IF(GUILE_FOUND)
	IF(NOT GUILE_FIND_QUIETLY)
		MESSAGE(STATUS "Guile ${GUILE_VERSION} was found at ${GUILE_INCLUDE_DIR}")
	ENDIF()
ELSE()
	SET(GUILE_DIR_MESSAGE "Guile was not found. Install guile-3.0-dev or guile-2.2-dev, or set GUILE_LIBRARY and GUILE_INCLUDE_DIR.")
	IF(NOT GUILE_FIND_QUIETLY)
