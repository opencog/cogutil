...
IF(HAVE_PY_INTERP)
	...
	IF (NOT NOSETESTS_EXECUTABLE)
		FIND_PROGRAM(NOSETESTS_EXECUTABLE nose2-3)
	ENDIF ()
	IF (NOT NOSETESTS_EXECUTABLE)
	...
	# Pytest will find and automatically run python tests.
	IF (Python3_Interpreter_FOUND)
		FIND_PROGRAM(PYTEST_EXECUTABLE pytest-3)
	ENDIF ()
	...
	ENDIF ()
	IF (PYTEST_EXECUTABLE AND CYTHON_FOUND AND HAVE_PY_LIBS)
		SET(HAVE_PYTEST 1)
		MESSAGE(STATUS "Using pytest executable " ${PYTEST_EXECUTABLE})
	ENDIF (PYTEST_EXECUTABLE AND CYTHON_FOUND AND HAVE_PY_LIBS)
